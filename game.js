...
const rewardCelebration = document.querySelector('#rewardCelebration');
...
function reveal(direction) {
  ...
  totalPointsLabel.textContent = `${totalPoints.toLocaleString()} P`;
  rewardAmount.textContent = `+${earned.toLocaleString()} P`;
  rewardCelebration.classList.remove('play');
  void rewardCelebration.offsetWidth;
  rewardCelebration.classList.add('play');
  setTimeout(() => rewardCelebration.classList.remove('play'), 1050);
